...
DTYPE_TWOTERMINALDCL1KEYS = {"NAME": str, "MDC": int, "RDC": float, "SETVL": float, "VSCHD": float, "VCMOD": float, "RCOMP": float, "DELTI": float, "METER": int, "DCVMIN": float, "CCCITMX": int, "CCCACC": float}
